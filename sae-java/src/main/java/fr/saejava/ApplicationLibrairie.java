...
public class ApplicationLibrairie extends javafx.application.Application {
    ...
    public void afficherAjoutMagasinView(Stage stage){
        ...
        try {
            ControllerAjouteMagasin controller = new ControllerAjouteMagasin(this, utilisateurConnexion);
    ...
    public void afficherAjoutVendeurView(Stage stage){
        ...
        try {
            ControllerAjouteVendeur controller = new ControllerAjouteVendeur(this, utilisateurConnexion);
            loader.setController(controller);
            this.root = loader.load();
            this.scene = new Scene(this.root);
            stage.setScene(scene);
